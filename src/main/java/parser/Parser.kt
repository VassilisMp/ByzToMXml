...
//        val noParentheses = stage1()
    ...
    private fun stage1(): String {
        ...
        // throw the exception if exists
        if (errorListener.exception != null)
            throw errorListener.exception!!
    ...
    private fun stage2(str: String): MutableList<Any> {
        println(str)
