...
//            val normalNotes = /*if (dotPlace > 0) division-1 else */division-1
    ...
    override fun toString(): String = when {
        dotPlace == 0 && division == 2 -> "gorgon"
        dotPlace == 1 && division == 2 -> "GorgonParestigmenoAristera"
        dotPlace == 2 && division == 2 -> "GorgonParestigmenoDexia"
        dotPlace == 0 && division == 3 -> "digorgon"
        dotPlace == 1 && division == 3 -> "DigorgonParestigmenoAristeraKato"
        dotPlace == 2 && division == 3 -> "DigorgonParestigmenoAristeraAno"
        dotPlace == 3 && division == 3 -> "DigorgonParestigmenoDexia"
        dotPlace == 0 && division == 4 -> "trigorgon"
        dotPlace == 1 && division == 4 -> "TrigorgonParestigmenoAristeraKato"
        dotPlace == 3 && division == 4 -> "TrigorgonParestigmenoAristeraPano"
        dotPlace == 4 && division == 4 -> "TrigorgonParestigmenoDexia"
